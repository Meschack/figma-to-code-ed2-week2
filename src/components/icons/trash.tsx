...
export const Trash = ({ width = 20, height = 20, stroke, ...rest }: Props) => {
  return (
    <svg width={width} height={height} fill='none' {...rest} viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
      <path
      ...
      <path
        ...
        strokeLinecap='round'
      />
      <path d='M7.9165 13.75V8.75' stroke='#1D1D1D' strokeWidth='1.5' strokeLinecap='round' />
      <path d='M12.0835 13.75V8.75' stroke='#1D1D1D' strokeWidth='1.5' strokeLinecap='round' />
    </svg>
  )
}
